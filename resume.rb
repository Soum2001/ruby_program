...
=begin
  ...
  It should have personal details, experience, job, skill, qualification, training, projects

  state for:
    PersonalDetail:
      name, email, mobile, place, preferred location
    experience:
      company_name, current_post, joining_date, exiting_date
      job:
        name, technology, start_date, end_date, post
    skill:
      name, level, duration
    qualification:
